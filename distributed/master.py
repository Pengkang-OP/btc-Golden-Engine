...
class WorkerRegistry:
    ...
    def __init__(self, assignment_size: int = DEFAULT_ASSIGNMENT_SIZE) -> None:
    ...
    def assign_range(self, worker_id: str) -> Assignment | None:
    ...
    def steal_range(self, worker_id: str) -> Assignment | None:
...
class MasterService(MasterServiceServicer):
    ...
    def __init__(self, registry: WorkerRegistry) -> None:
        ...
        self._hit_count = 0
        self._db: ResultDB | None = None  # 延迟初始化 ResultDB
    ...
    def ReportHit(
        ...
        try:
            ...
            _logger.exception("[Master] 持久化碰撞结果失败: %s", exc)
