...
class KernelTimer:
    ...
    def update(self, elapsed: float, keys: int) -> None:
        ...
        if not self._calibrated:
            ...
            # 指数移动平均, α = 0.3, 快速适应实际性能变化  # noqa: ERA001
...
def warn_tdr_settings(quiet: bool = False) -> float | None:  # noqa: FBT001, FBT002
    ...
    try:
        ...
        _tdr_default = 2
        if tdr_delay <= _tdr_default and not quiet:
        ...
        elif tdr_delay > _tdr_default and not quiet:
